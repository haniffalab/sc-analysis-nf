...
def filter_reads(samples: str):
    ...
    sc.pl.violin(
        adata, "pct_counts_mt", save="_qcmetrics_pctcountsmt.png", show=False
    )  # plot2
    sc.pl.scatter(
        adata,
        "total_counts",
    ...
    for sample in sample_list:
        ...
        adata_byid.obs["outlier"] = is_outlier(
            adata_byid, "log1p_total_counts", 8
    ...
    adata.obs[
        ["predicted_doublets", "outlier", "mt_outlier", "n_genes_by_counts", "QC"]
    ].head(10)

    # adata.layers["counts"] = adata.X.copy()
    adata.write("adata_filter.h5ad")
