...
##save the result 
results_file_4 = "pbmc3k_4.h5ad"
adata.write(results_file_4)
...
adata.write(results_file_4, compression='gzip')  # `compression='gzip'` saves disk space, but slows down writing and subsequent reading
