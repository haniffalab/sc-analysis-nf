...
sc.pl.violin(adata, 'n_genes_by_counts',
             jitter=0.4, save= "_1.png", show=False)
#second violin plot
sc.pl.violin(adata, 'total_counts',
             jitter=0.4,  save="_2.png", show=False)
#third violin plot
sc.pl.violin(adata, 'pct_counts_mt',
             jitter=0.4,  save="_3.png", show=False)

#Remove cells that have too many mitochondrial genes expressed or too many total counts:
sc.pl.scatter(adata, x='total_counts', y='pct_counts_mt', save="_pct_counts_mt.png", show=False)
sc.pl.scatter(adata, x='total_counts', y='n_genes_by_counts', save="_n_genes_by_count.png", show=False)
