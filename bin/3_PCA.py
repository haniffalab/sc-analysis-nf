...
def pca(pca_adata_input:str, pca_outfile:str):
    pca_outfile = 'pbmc3k.h5ad'  # the file that will store the analysis result
    adata = sc.read_h5ad(pca_adata_input)
    ...
    sc.pl.pca(adata, color='CST3', save= "_scatter_3.png", show=False)
    ...
    sc.pl.pca_variance_ratio(adata, log=True, save= "_3.png", show=False)

    # Save the result.
    adata.write(pca_outfile)
    ...
    sc.pl.umap(adata, color=['CST3', 'NKG7', 'PPBP'], save="_raw_embedding_neighbourhood_3.png", show=False)
    ...
    sc.pl.umap(adata, color=['CST3', 'NKG7', 'PPBP'], use_raw=False, save="_embedding_neighbourhood_3.png", show=False)
    ...
    sc.pl.umap(adata, color=['leiden', 'CST3', 'NKG7'], save="_leiden_graph_clustering_3.png", show=False)
